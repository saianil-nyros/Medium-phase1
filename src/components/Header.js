...
getData=(e)=>{
	...
	render(){
const data = this.state.stories_data.slice(6,8).map((index)=>
			<Row>
...
const data1=this.state.stories_data.slice(8,9).map((index)=>
...
const data2=this.state.stories_data.slice(9,10).map((index)=>
...
<div>
    <Route exact path="/viewstory"  component={Storiespage}/>
    <Route exact path="/viewstory"  component={Storiespage}/>
